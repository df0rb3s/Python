#Stolen from "Gray Hat Python" --Justin Seitz No Starch Press 2009
...
arg_adderess = kernel32.VirtualAllocEx(h_process, 0, dll_len, VIRTUAL_MEM,
                                       PAGE_READWRITE)
...
print "[*] Remote thread with ID 0x%08x crated." % thread_id.value